...
dosya_yolu = "C:\\Users\\enesk\\OneDrive\\Masaüstü\\Yoloprojesi\\Object-Detection\\peoplecounteryolov8-main\\deneme.txt"
...
#        print(row)
   ...
   # print(people_entering)
    #print(len(entering))
    #print(len(exiting))
    print("kişi sayısı : ", len(entering)-len(exiting))


    toplam = len(entering)-len(exiting)
    def veri_yaz(toplam):
        with open(dosya_yolu, "w") as dosya:
            dosya.write(toplam + "\n")


    anlik_veri = str(toplam+20)  # Örnek olarak zaman damgasını kullanıyoruz
